...
if found_files:
    ...
    if len(found_files) >= 4:  # If we found at least model + 3 preprocessors
        ...
        # Write the fixed prediction script
        fixed_script = f"""import numpy as np
import pandas as pd
import joblib
...
print("\\n💡 Next steps:")
print("   1. This confirms your model works!")
print("   2. For real predictions, update predict_matches_real.py")
print("   3. Change the filenames to:")
print(f"      - Model: {model_name}")
print(f"      - Scaler: {scaler_name}")
print(f"      - Label Encoder: {label_encoder_name}")
print(f"      - Team Encoder: {team_encoder_name}")
"""
        ...
        with open('predict_FIXED.py', 'w', encoding='utf-8') as f:
